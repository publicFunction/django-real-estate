...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeaturedProperty'
        db.create_table(u'property_featuredproperty', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('property', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['property.Property'])),
        ))
        db.send_create_signal(u'property', ['FeaturedProperty'])


    def backwards(self, orm):
        # Deleting model 'FeaturedProperty'
        db.delete_table(u'property_featuredproperty')
